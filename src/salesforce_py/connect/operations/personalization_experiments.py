...
class PersonalizationExperimentsOperations(ConnectBaseOperations):
    ...
    async def create_experiment(
        ...
        *,
        ...
        return await self._post("personalization/abn-experiments", json=body, params=params)
    ...
    async def get_experiment(self, id_or_name: str) -> dict[str, Any]:
        ...
        Returns:
            Personalization Experiment dict.
        """
        return await self._get(f"personalization/abn-experiments/{id_or_name}")
    ...
    async def delete_experiment(self, id_or_name: str) -> dict[str, Any]:
        ...
        """
        return await self._delete(f"personalization/abn-experiments/{id_or_name}")

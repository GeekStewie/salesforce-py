...
class PersonalizationRecommendersOperations(ConnectBaseOperations):
    ...
    async def list_recommenders(
        ...
        *,
        ...
        return await self._get("personalization/personalization-recommenders", params=params)

    async def create_recommender(self, body: dict[str, Any]) -> dict[str, Any]:
        ...
        """
        return await self._post("personalization/personalization-recommenders", json=body)
    ...
    async def get_recommender(self, id_or_name: str) -> dict[str, Any]:
        ...
        Returns:
            Personalization Recommender dict.
        """
        return await self._get(f"personalization/personalization-recommenders/{id_or_name}")

    async def update_recommender(self, id_or_name: str, body: dict[str, Any]) -> dict[str, Any]:
    ...
    async def delete_recommender(self, id_or_name: str) -> dict[str, Any]:
        ...
        """
        return await self._delete(f"personalization/personalization-recommenders/{id_or_name}")

    async def list_recommender_jobs(self, id_or_name: str) -> dict[str, Any]:
        ...
        """
        return await self._get(f"personalization/personalization-recommenders/{id_or_name}/jobs")
